...
const updateEmpenhoUseCase = new UpdateEmpenhoUseCase(repository, findCompanyById);
const updateStatusEmpenhoUseCase = new UpdateStatusEmpenhoUseCase(repository);
const empenhoController = new EmpenhoController(createEmpenhoUseCase, listEmpenhosUseCase, deleteEmpenhoUseCase, updateEmpenhoUseCase, updateStatusEmpenhoUseCase);
const token = new TokenGenerator();
const authMiddleware = new AuthMiddleware(token);
EmpenhoRoutes.post("/empenho/create", authMiddleware.handle, (req, res) => empenhoController.create(req, res));
EmpenhoRoutes.get("/empenho/list", (req, res) => empenhoController.list(req, res));
EmpenhoRoutes.delete("/empenho/delete/:empenhoId", authMiddleware.handle, (req, res) => empenhoController.delete(req, res));
EmpenhoRoutes.put("/empenho/update/:empenhoId", authMiddleware.handle, (req, res) => empenhoController.update(req, res));
EmpenhoRoutes.put("/empenho/update-status/:empenhoId", authMiddleware.handle, (req, res) => empenhoController.updateStatus(req, res));
//# sourceMappingURL=EmpenhoRoutes.js.map