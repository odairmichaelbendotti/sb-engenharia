...
const companyController = new CompanyController(createCompanyUseCase, listCompaniesUseCase, deleteCompanyUseCase, updateCompanyUseCase);
CompanyRoutes.post("/company/create", (req, res) => companyController.create(req, res));
CompanyRoutes.get("/company/list", (_, res) => companyController.list(_, res));
CompanyRoutes.delete("/company/delete/:id", (req, res) => companyController.delete(req, res));
CompanyRoutes.put("/company/update/:id", (req, res) => companyController.update(req, res));
