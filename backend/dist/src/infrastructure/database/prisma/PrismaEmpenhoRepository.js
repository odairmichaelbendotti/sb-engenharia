...
export class PrismaEmpenhoRepository {
    ...
    async findByEmpenhoId(empenhoId) {
        try {
    ...
    async list() {
        try {
            const [empenhos, totalEmpenhos, totalEmpenhosAmount, activeEmpenhos, activeEmpenhosAmount, completedEmpenhos, completedEmpenhosAmount,] = await Promise.all([
            ...
            const mergedData = {
                ...
                completedEmpenhos,
                completedEmpenhosAmount: (completedEmpenhosAmount._sum.value || 0) / 100,
            };
            return mergedData;
        }
        catch (error) {
    ...
    async update(empenhoId, empenho) {
        try {
    ...
    async updateStatus(empenhoId, status) {
        try {
            console.log(status);
    ...
    async incrementInvoiceValue(empenhoId, value) {
        try {
...
//# sourceMappingURL=PrismaEmpenhoRepository.js.map